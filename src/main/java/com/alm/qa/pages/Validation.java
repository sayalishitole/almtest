...
public class Validation extends TestBase {
	...
	//String projectPath="D:\\Sayali-updated\\LeapALM\\SPFx\\Test Packages\\helloworld-webpart.sppkg";
		...
		public String Validationflow(String appname,String projectpath) throws InterruptedException {
			String String = "https://rapidalm-staging.azurewebsites.net/#/spfx/validation/finish";
			Thread.sleep(8000);
			...
			Thread.sleep(5000);
			// Confirm.click();
			driver.findElement(By.cssSelector("button.btn.btn-success.ng-binding")).sendKeys(Keys.ENTER);
			System.out.println("DEBUG MESSAGE:Validation Confirmed");
	 
	
	
			
			//return new SpfxDeployments();
			return String;
